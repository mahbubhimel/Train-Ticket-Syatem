...
<script>
    ...
    var id = <?php echo json_encode($id); ?>; //convert array into json representation
    ...
    function purchaseMessage(id){
        ...
        $.ajax({
            ...
            url: '<?php echo e(url('/purchased-details')); ?>',
            type: 'GET',
            data: {train_id: id},
...
<?php echo $__env->make('layout.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_system\blog\resources\views/ticketsview.blade.php ENDPATH**/ ?>